...
Criando as informações do eml. Importante criar um uuid para o arquivo, como demosntrado a seguir. Para mais informações sobre o que é um uuid ver [esta explicação na Wikipedia](https://en.wikipedia.org/wiki/Universally_unique_identifier)
...
Finalmente criando o arquivo eml e validando 
